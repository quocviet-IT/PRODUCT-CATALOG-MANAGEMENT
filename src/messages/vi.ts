...
export const vi = {
  ...
  chia_se: {
    ...
    thong_so_them_nhan: "Thông số tự điền",
    thong_so_them_tuy_chon: "Không bắt buộc, tối đa {n} dòng. Hiện cùng các thông số khác trên trang khách.",
    thong_so_them_ten_goi_y: "Tên, ví dụ: Đá chính",
    thong_so_them_gia_tri_goi_y: "Nội dung, ví dụ: Kim cương 5 ly",
    thong_so_them_nut: "Thêm thông số",
    thong_so_them_bo: "Bỏ dòng thông số {n}",
